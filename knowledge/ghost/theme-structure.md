...
#### 
[​](https://docs.ghost.org/themes/structure#custom-%7B%7Btemplate-name%7D%7D-hbs)
...
#### 
[​](https://docs.ghost.org/themes/structure#error-%7B%7Berror-class%7D%7Dxx-hbs)
...
#### 
[​](https://docs.ghost.org/themes/structure#error-%7B%7Berror-code%7D%7D-hbs)
...
Here are some of the most common optional properties that can be used in the `package.json` file:
  ...
  * `config.image_sizes` — read more about using [image sizes](https://docs.ghost.org/themes/assets) guide for more details
  * `config.card_assets` — configure the [card CSS and JS](https://docs.ghost.org/themes/content#editor-cards) that Ghost automatically includes
